...
import SimpleAurora from "../components/SimpleAurora"
    ...
    <div className="bg-gradient-to-b from-primary-bg via-primary-secondary to-primary-bg">
            ...
            <div className="relative">
              <div className="bg-gradient-primary rounded-2xl p-1">
                <div className="bg-primary-secondary rounded-2xl p-8 h-80 flex items-center justify-center shadow-indigo-card overflow-hidden">
                  <Image
                    src="/images/ai-team-collaboration.png"
            ...
            <div className="relative order-2 lg:order-1">
              <div className="bg-gradient-primary rounded-2xl p-1">
                <div className="bg-primary-bg rounded-2xl p-8 h-80 flex items-center justify-center shadow-indigo-card overflow-hidden">
                  <Image
                    src="/images/future-business.png"
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center glass-card-strong border border-white/10 rounded-2xl p-8 card-3d hover:shadow-card-glow transition-all duration-300"
              >
                <div className="text-4xl md:text-5xl font-bold font-sora gradient-text mb-2">{stat.number}</div>
                <div className="text-text-muted font-inter">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <Link
            href="/contact"
            className="metallic-fluid-btn bg-gradient-primary text-white px-10 py-5 rounded-full font-bold font-poppins hover:shadow-primary-glow transition-all duration-300 glow-effect inline-flex items-center text-lg"
          >
