      ...
      <div className="max-w-7xl mx-auto">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4">
            <div className="bg-primary-bg/95 backdrop-blur-md border border-border-gray rounded-none shadow-lg p-4 flex flex-col space-y-4">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
              ...
              <div className="pt-4 border-t border-border-gray">
                <Link
                  href="/contact"
                  className="font-bold font-poppins w-full text-center py-2 block rounded-none"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Book Your Appointment
                </Link>
