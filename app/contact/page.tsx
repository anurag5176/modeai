...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      details: ["hello@modeai.com", "support@modeai.com"],
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: MapPin,
      title: "Address",
      details: ["ModeAI Headquarters", "Pune, Maharashtra, India"],
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-primary-bg border border-border-gray rounded-lg text-text-primary font-inter focus:outline-none focus:border-accent-purple transition-colors duration-300"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-primary-bg border border-border-gray rounded-lg text-text-primary font-inter focus:outline-none focus:border-accent-purple transition-colors duration-300 resize-vertical"
                  ...
                  <button
                    ...
                    className="metallic-fluid-btn w-full bg-gradient-purple text-white px-8 py-4 rounded-full font-bold font-poppins hover:shadow-purple-glow transition-all duration-300 glow-effect inline-flex items-center justify-center disabled:opacity-50"
                  >
                    {isSubmitted ? (
                      <>
