...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "Email",
      details: ["admin@mode-ai.co", "support@mode-ai.co"],
              ...
              <div className="glass-card-strong border border-white/10 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <StarBorder
                    ...
                    className="w-full font-bold font-poppins hover:shadow-primary-glow transition-all duration-300 inline-flex items-center justify-center text-lg rounded-full disabled:opacity-50"
                    color="#A686D1"
                    speed="2.5s"
                  >
                    {isSubmitted ? (
